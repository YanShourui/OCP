            ...
            <div class="col-3">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-body">
                        ...
                        <p class="text-center" style="font-size: 18px; font-weight: 700;">闫守瑞</p>
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <a href="#" style="text-decoration: none;">
                                    <div class="user-myspace-base-person-info-bottom-item" title="5">
                                        <div class="user-myspace-base-person-info-bottom-item-title">关注数</div>
                                        <div class="user-myspace-base-person-info-bottom-item-content">0</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-xs-4">
                                <a href="#" style="text-decoration: none;">
                                    <div class="user-myspace-base-person-info-bottom-item" title="5">
                                        <div class="user-myspace-base-person-info-bottom-item-title">粉丝数</div>
                                        <div
                                            class="user-myspace-base-person-info-bottom-item-content user-myspace-base-person-info-bottom-item-content-cnt">
                                            2000
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-xs-4">
                                <div class="user-myspace-base-person-info-bottom-item-normal" title="1081">
                                    <div class="user-myspace-base-person-info-bottom-item-title">阅读量</div>
                                    <div class="user-myspace-base-person-info-bottom-item-content">2000</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        <span style="font-size: 130%">我的文章</span>
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input v-model="botadd.title" type="text" class="form-control"
                                                id="add-bot-title" placeholder="请输入文章名称">
                                        </div>
                                        <div class="mb-3">
                                            <label for="add-bot-description" class="form-label">简介</label>
                                            <textarea v-model="botadd.description" class="form-control"
                                                id="add-bot-description" rows="3" placeholder="请输入文章简介"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="add-bot-code" class="form-label">内容</label>
